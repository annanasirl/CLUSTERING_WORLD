...
path = "../data/SERIES/SERIES_clara_6_20260220_175058/"
...
output_dir = "../data/series analysis/clara/"
os.makedirs(output_dir, exist_ok=True)

output_path = os.path.join(output_dir, "series_analysis_clara_6.csv")
...
# Salvataggio matrice
transition_output_path = os.path.join(output_dir, "trans_matrix_clara.csv")
...
stats_output_path = os.path.join(output_dir, "clara_stats.csv")
